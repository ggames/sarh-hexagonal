...
@Mapper(componentModel = "spring", uses = { CharacterPositionMapper.class, TransformationMapper.class, OrganizationalUnitMapper.class, PointMapper.class, PositionMapper.class})
